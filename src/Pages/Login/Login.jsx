      ...
      <div className='bg-overlay'>
        <div className='bg-form'>
          <div className="form-tags">
            <h1 style={{ fontStyle: "bold" }}>Sign In</h1>
            <p style={{ color: "gray" }}>{error ? error : null}</p>
            <form onSubmit={handleSubmit} >
              ...
              <p><span style={{ color: "gray" }}>New To Netflix?</span><Link to="./login" style={{ textDecoration: 'none', color: "white " }} >{" "}&nbsp;Sign Up</Link></p>
            </form>
          </div>
        </div>
      </div>
